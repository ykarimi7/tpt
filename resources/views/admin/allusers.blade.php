                        ...
                        <div class="card-body">
                            <div class="title-header option-title">
                                ...
                                <form class="d-inline-flex">
                                    <a href="{{url('admin/addnewuser')}}" class="align-items-center btn btn-theme d-flex">
                            ...
                            <div class="table-responsive table-product">
                                <table class="table all-package theme-table" id="table_id">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-image">
                                                <img src="{{url('assets1/images/users/1.jpg')}}" class="img-fluid"
                                                     alt="">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-image">
                                                <img src="{{url('assets1/images/users/2.jpg')}}" class="img-fluid"
                                                     alt="">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-image">
                                                <img src="{{url('assets1/images/users/3.jpg')}}" class="img-fluid"
                                                     alt="">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-image">
                                                <img src="{{url('assets1/images/users/4.jpg')}}" class="img-fluid"
                                                     alt="">
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="table-image">
                                                <img src="{{url('assets1/images/users/5.jpg')}}" class="img-fluid"
                                                     alt="">
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <ul>
                                                <li>
                                                    <a href="{{url('assets1/images/users/5.jpg')}}">
                                                        <i class="ri-eye-line"></i>
                                                    </a>
                                                </li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                <li>
                                                    <a href="{{url('assets1/images/users/2.jpg')}}">
                                                        <i class="ri-eye-line"></i>
                                                    </a>
                                                </li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                <li>
                                                    <a href="{{url('assets1/images/users/4.jpg')}}">
                                                        <i class="ri-eye-line"></i>
                                                    </a>
                                                </li>
