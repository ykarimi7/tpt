                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox1">
                                            <div>
                                                <img src="{{url('assets1/images/product/1.png')}}"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox2">
                                            <div>
                                                <img src="{{url('assets1/images/product/2.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox3">
                                            <div>
                                                <img src="{{url('assets1/images/product/3.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox4">
                                            <div>
                                                <img src="{{url('assets1/images/product/4.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox5">
                                            <div>
                                                <img src="{{url('assets1/images/product/5.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox6">
                                            <div>
                                                <img src="{{url('assets1/images/product/6.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox7">
                                            <div>
                                                <img src="{{url('assets1/images/product/7.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox8">
                                            <div>
                                                <img src="{{url('assets1/images/product/8.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox9">
                                            <div>
                                                <img src="{{url('assets1/images/product/9.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox11">
                                            <div>
                                                <img src="{{url('assets1/images/product/14.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox12">
                                            <div>
                                                <img src="{{url('assets1/images/product/13.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox13">
                                            <div>
                                                <img src="{{url('assets1/images/product/16.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
                                ...
                                <div>
                                    <div class="library-box">
                                        ...
                                        <label for="myCheckbox14">
                                            <div>
                                                <img src="{{url('assets1/images/product/20.png')}}"
                                                     class="img-fluid bg-img bg_size_content" alt="">
                                            </div>
                                            <div class="dropdown">
                                                <a class="" href="#" role="button" id="dropdownMenuLink"
